...
def init():
    if not os.path.exists('./spider/commentsData.csv'):
        with open('./spider/commentsData.csv','w',encoding='utf8',newline='') as csvfile:
...
def wirterRow(row):
        with open('./spider/commentsData.csv','a',encoding='utf8',newline='') as csvfile:
            wirter = csv.writer(csvfile)
            wirter.writerow(row)
...
def start():
    ...
    with open('./spider/articleData.csv','r',encoding='utf8') as readerFile:
